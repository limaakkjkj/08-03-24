...
function App() {
  ...
  return(
    <form onSubmit = {handleSubmit}>
      ...
      <input type="text" name="sobrenome" id="sobrenome" value={sobrenome} onChange={(e) => setSobrenome(e.target.value)}/> <br />

      <label htmlFor="email">Email:</label>
      <input type="email" name="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)}/> <br />

      <label htmlFor="senha">Senha:</label>
      <input type="password" name="senha" id="senha" value={senha} onChange={(e) => setSenha(e.target.value)}/> <br />



      <div className="check">
      <input type="checkbox" name="checkbox" id="check" />
      <label htmlFor="checkboxf">Aceito os termos</label>
      </div>
